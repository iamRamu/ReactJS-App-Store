...
class AppStore extends Component {
  ...
  render() {
    ...
    const searchResults = filteredAppsList.filter(eachResult =>
      eachResult.appName.toLowerCase().includes(inputSearch.toLowerCase()),
    )
      ...
      <div className="bg-container">
        ...
        <ul className="appsListContainer">
          {searchResults.map(eachApp => (
            <AppItem appListDetails={eachApp} key={eachApp.appId} />
          ))}
        </ul>
      </div>
    )
